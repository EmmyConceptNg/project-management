...
export default function TaskBreakdown() {
  ...
  const [tasks, setTasks] = useState([
    ...
    {
      name: "Development of Settings Feature",
      status: "Back Log",
      count: 5,
    },
    {
          ...
          {tasks.map((task, index) => (
            <>
              <Grid item md={4} lg={4} sm={6} xs={12}>
                <Box
                minWidth = {{ xs :'280px', sm : '280px', md : '340px', lg: '340px' }}
                ...
                <Stack spacing={2}>
                  {projects.map((item, index) => (
                    <Box
                      onClick={() =>
                        navigate(`/dashboard/projects/ongoing/1/members`)
                      }
                      sx={{
                        cursor: "pointer",
                      ...
                      border="1px solid #D9D9D9"
                      borderRadius="8px"
                      height={{ md:"200px", lg: '200px', xs : '250px', sm : '250px' }}
                      px={2}
                      py={1.5}
                    >
                      <Stack
