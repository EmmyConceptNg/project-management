export const InviteMail = (_team, workspaceName, link) => {
  return ` <center>
                                         ...
                                         <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                             ...
                                             <tr>
                                                 <td data-text="Title" data-font="Primary" align="center"
                                                     ...
                                                     Invitation to join ${workspaceName}</td>
                                             </tr>
                                             <tr>
                                                 <td data-text="Description" data-font="Primary" align="center"
                                                     ...
                                                     Hello ${_team}, You have been invited to join ${workspaceName}. Click on the link below to accept invitation.</td>
                                             </tr>
                                             <tr>
                                                         ...
                                                         <tr>
                                                             <td data-btn="Button Large" align="center"
                                                                 ...
                                                                 <a data-font="Primary" href="${link}"
                                                                     style="color: rgb(255, 255, 255); font-family: Poppins, sans-serif; font-size: 14px; font-weight: 600; letter-spacing: 0px; line-height: 24px; display: block; text-decoration: none; white-space: nowrap; padding: 12px 30px;">Accept</a>
                                                             </td>
                                                         </tr>
                                                     </table>
                                                 </td>
