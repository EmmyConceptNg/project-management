export const TaskMail = (user, milestone, link) => {
  return ` <center>
                                         ...
                                         <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                             ...
                                             <tr>
                                                 <td data-text="Description" data-font="Primary" align="center"
                                                     ...
                                                     Hello ${user.fullName}, a task has been assigned to you on ${milestone.name} milestone. Click on the link below to view.</td>
                                             </tr>
                                             <tr>
